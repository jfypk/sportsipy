...
BOXSCORE_SCHEME = {
    ...
    'away_name': 'div[class="game_summary nohover current"]',
    'home_name': 'div[class="game_summary nohover current"]',
    'winning_name': '',
    'winning_abbr': 'div[class="game_summary nohover current"] tr.winner td:first',
    'losing_name': '',
    'losing_abbr': 'div[class="game_summary nohover current"] tr.loser td:first',
